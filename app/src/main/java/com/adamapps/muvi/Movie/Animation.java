...
public class Animation extends AppCompatActivity {
    ...
    Elements linkSearchElm, imageSearchElm;
    Elements nextElement;
    String url = "https://www1.hdonline.eu/genre/animation/";
        ...
        public void onBindViewHolder(@NonNull HDHolder holder, final int position) {
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(Animation.this, MovieDetail.class);
    ...
    public class HDSearchAdapter extends RecyclerView.Adapter<HDHolder> {
        ...
        public HDHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(Animation.this).inflate(R.layout.letter_detail_layout, parent, false);
            return new HDHolder(v);
        }
        ...
        public void onBindViewHolder(@NonNull HDHolder holder, final int position) {
            ...
            holder.setImage(Animation.this, imageSearch.get(position));
            holder.mView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    YoYo.with(Techniques.RubberBand).duration(500).playOn(v);
